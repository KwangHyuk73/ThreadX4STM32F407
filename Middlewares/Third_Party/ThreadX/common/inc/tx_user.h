...
*/
////////////////////////////////////////////////////////////////
#define	TX_ZERO					((ULONG) 0)
#define TX_FULL                                 ((ULONG) 0xFFFFFFFFUL)

#define TX_MAX_PRIORITIES						32
#define TX_MINIMUM_STACK						256
#define TX_THREAD_USER_EXTENSION				void *TxEventFlagsGroupPtr;
#define TX_TIMER_THREAD_STACK_SIZE				1024
#define TX_TIMER_THREAD_PRIORITY				0
#define TX_SYSTEM_BYTE_POOL_SIZE				(64*1024)
#define TX_SYSTEM_BLOCK_POOL_SIZE				(8*1024)
